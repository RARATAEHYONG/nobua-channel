...
export const GOODS_ITEMS: GoodsItem[] = [
  {
    ...
    description:
      "のぶあチャンネルのオリジナルロゴをプリントしたTシャツです。シンプルなブラック生地で、普段使いにもライブやイベントにも合わせやすい一枚です。初回限定25枚で制作しました。",
    sizes: ["S", "M", "L"],
    details: [
  ...
  },
  {
    ...
    description:
      "のぶあオリジナルロゴをデザインしたコルクコースターです。テーブルまわりに置きやすい落ち着いた質感で、日常の中でもさりげなく使えるアイテムです。初回限定8枚で制作しました。",
    details: [
      { label: "素材", value: "コルク" },
      { label: "形状", value: "円形" },
  ...
  },
  {
    ...
    description:
      "シンプルなブラック生地に、のぶあオリジナルロゴをプリントしたトートバッグです。A4サイズもゆったり入る使いやすいサイズで、通勤・通学やお買い物、ライブのお供にもぴったり。僕のオカンはエコバッグ扱いしています。普段使いしやすいデザインなので、さりげなく応援していただけるアイテムになっています。いつも応援してくださる皆さまへの感謝を込めて制作しました。",
    details: [
      { label: "カラー", value: "ブラック" },
  ...
  },
  {
    ...
    imageBackground: "light",
    description:
      "のぶあオリジナルロゴをデザインした、マイクロファイバー素材のマフラータオルです。サイズは約1100×210mm。首に掛けやすいロングサイズで、ライブやイベントでの応援はもちろん、スポーツやお出かけの際にもお使いいただけます。肌触りが良く、吸水性にも優れたマイクロファイバー素材を採用。シンプルなデザインなので、日常の中でもさりげなくお使いいただける一枚です。いつも応援してくださる皆さまへの感謝を込めて制作しました。皆さまの毎日に、少しでも音楽と彩りをお届けできたら嬉しいです。",
    details: [
