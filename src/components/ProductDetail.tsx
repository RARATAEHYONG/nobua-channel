  ...
  return (
    <section className="mx-auto max-w-[1600px] px-6 py-12 sm:px-10 lg:px-16">
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          <div className={`relative aspect-square overflow-hidden ${imageBg}`}>
            {item.badge && (
          ...
          <div className="mt-5 grid grid-cols-2 gap-4">
            {images.map((image, index) => (
              <button
                ...
                className={`relative aspect-square overflow-hidden border ${imageBg} transition-colors ${
                  selectedImage === image
                    ? "border-accent"
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-8 whitespace-pre-line border-t border-white/10 pt-8 font-jp text-base leading-loose text-white/60">
            {item.description}
          </p>
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-[152px_1fr]">
